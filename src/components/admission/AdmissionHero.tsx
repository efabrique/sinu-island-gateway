...
const AdmissionHero = () => {
  return (
    <section className="bg-[#2A1B3D] py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            International Student Admission Requirements
          </h1>
          <p className="text-lg md:text-xl text-[#A4B3B6] mb-8 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-12">
            <div className="flex flex-col items-center">
              <div className="bg-[#D83F87] p-4 rounded-full mb-4">
                <GraduationCap className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Academic Excellence</h3>
              <p className="text-[#A4B3B6] text-center text-sm">High-quality education standards</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-[#D83F87] p-4 rounded-full mb-4">
              ...
              <p className="text-[#A4B3B6] text-center text-sm">Internationally recognized qualifications</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-[#D83F87] p-4 rounded-full mb-4">
              ...
              <p className="text-[#A4B3B6] text-center text-sm">Multicultural learning environment</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-[#D83F87] p-4 rounded-full mb-4">
              ...
              <p className="text-[#A4B3B6] text-center text-sm">Transparent admission procedures</p>
            </div>
          </div>
        </div>
      </div>
