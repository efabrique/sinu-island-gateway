    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-center w-12 h-12 bg-[#8ecae6] rounded-full mx-auto mb-3">
          ...
          <div className="bg-[#8ecae6]/20 rounded-lg p-6">
            <h3 className="text-xl font-bold text-[#082952] mb-4">Important Information</h3>
            <ul className="space-y-2 text-[#082952]">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#219ebc] mr-2 mt-0.5 flex-shrink-0" />
