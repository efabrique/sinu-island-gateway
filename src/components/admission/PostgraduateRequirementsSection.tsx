        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <GraduationCap className="h-6 w-6 text-[#219ebc] mr-2" />
            ...
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <Users className="h-6 w-6 text-[#219ebc] mr-2" />
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-[#8ecae6]/10 rounded-lg">
                    ...
                    <Badge variant="outline" className="border-[#219ebc] text-[#082952]">October 31</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#8ecae6]/10 rounded-lg">
                    <span className="font-medium text-[#082952]">Semester 2</span>
                    <Badge variant="outline" className="border-[#219ebc] text-[#082952]">March 31</Badge>
                  </div>
