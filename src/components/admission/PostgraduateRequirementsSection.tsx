        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <Card className="border-[#AAE847] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <GraduationCap className="h-6 w-6 text-[#AAE847] mr-2" />
                  <CardTitle className="text-[#D950AE]">Master's Degree Requirements</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-[#AAE847] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <Users className="h-6 w-6 text-[#AAE847] mr-2" />
                  <CardTitle className="text-[#D950AE]">Doctoral Degree Requirements</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3 text-[#D950AE]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Card className="border-[#EFC6D4] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <FileText className="h-6 w-6 text-[#AAE847] mr-2" />
                  <CardTitle className="text-[#D950AE]">Additional Documents</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-[#D950AE]">
                  <li className="flex items-center">
                    <span className="w-1.5 h-1.5 bg-[#AAE847] rounded-full mr-2"></span>
            ...
            <Card className="border-[#EFC6D4] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <Clock className="h-6 w-6 text-[#AAE847] mr-2" />
                  <CardTitle className="text-[#D950AE]">Application Timeline</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-[#EEEDEE] rounded-lg">
                    <span className="font-medium text-[#D950AE]">Semester 1</span>
                    <Badge variant="outline" className="border-[#AAE847] text-[#D950AE]">October 31</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#EEEDEE] rounded-lg">
                    <span className="font-medium text-[#D950AE]">Semester 2</span>
                    <Badge variant="outline" className="border-[#AAE847] text-[#D950AE]">March 31</Badge>
                  </div>
                  <p className="text-sm text-[#D950AE] mt-2">
