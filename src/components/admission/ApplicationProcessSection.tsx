      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card className="border-[#ffb703] hover:shadow-lg transition-shadow relative bg-white">
              <CardHeader className="text-center">
                <div className="w-12 h-12 bg-[#ffb703] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#082952] font-bold text-lg">1</span>
                </div>
              ...
              <CardContent>
                ...
                <div className="text-center">
                  <Badge variant="outline" className="border-[#ffb703] text-[#082952]">
                    5 minutes
                  </Badge>
                </div>
              </CardContent>
              <div className="absolute -right-3 top-1/2 transform -translate-y-1/2 hidden lg:block">
                <ArrowRight className="h-6 w-6 text-[#ffb703]" />
              </div>
            </Card>
            ...
            <Card className="border-[#ffb703] hover:shadow-lg transition-shadow relative bg-white">
              <CardHeader className="text-center">
                <div className="w-12 h-12 bg-[#ffb703] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#082952] font-bold text-lg">2</span>
                </div>
            ...
            <Card className="border-[#ffb703] hover:shadow-lg transition-shadow relative bg-white">
              <CardHeader className="text-center">
                <div className="w-12 h-12 bg-[#ffb703] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#082952] font-bold text-lg">3</span>
                </div>
            ...
            <Card className="border-[#ffb703] hover:shadow-lg transition-shadow bg-white">
              <CardHeader className="text-center">
                <div className="w-12 h-12 bg-[#ffb703] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#082952] font-bold text-lg">4</span>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow bg-white">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-[#edf4ff] rounded-lg">
                    <div className="flex items-center">
                      <FileText className="h-5 w-5 text-[#ffb703] mr-2" />
                  ...
                  <div className="flex items-center justify-between p-3 bg-[#edf4ff] rounded-lg">
                    <div className="flex items-center">
                      <MessageCircle className="h-5 w-5 text-[#ffb703] mr-2" />
            ...
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow bg-white">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <Phone className="h-6 w-6 text-[#ffb703] mr-2" />
                  <CardTitle className="text-[#082952]">Application Support</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-[#8ecae6] rounded-lg border border-[#219ebc]">
                    ...
                    <div className="space-y-2 text-sm text-[#082952]">
                      <div className="flex items-center">
                        <Mail className="h-4 w-4 text-[#082952] mr-2" />
                        <span>international@sinu.edu.sb</span>
                      </div>
                      <div className="flex items-center">
                        <Phone className="h-4 w-4 text-[#082952] mr-2" />
                        <span>+677 30123</span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="text-center">
            <div className="bg-[#219ebc] rounded-lg p-8 text-white border border-[#ffb703]">
              <h3 className="text-2xl font-bold mb-4">Ready to Apply?</h3>
              <p className="text-lg mb-6 text-[#8ecae6]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button variant="outline" className="border-[#8ecae6] text-[#8ecae6] hover:bg-[#8ecae6] hover:text-[#082952] px-8 py-3">
                  Download Checklist
                </Button>
              </div>
            </div>
