          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                <Calculator className="h-12 w-12 text-[#219ebc] mx-auto mb-2" />
                <CardTitle className="text-[#082952]">Business & Economics</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">Mathematics</Badge>
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">English</Badge>
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">Economics (preferred)</Badge>
                </div>
            ...
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                <Beaker className="h-12 w-12 text-[#219ebc] mx-auto mb-2" />
                <CardTitle className="text-[#082952]">Science & Health</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">Biology</Badge>
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">Chemistry</Badge>
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">Physics</Badge>
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">Mathematics</Badge>
                </div>
                <p className="text-sm text-[#082952] mt-3">
            ...
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                <BookOpen className="h-12 w-12 text-[#219ebc] mx-auto mb-2" />
                <CardTitle className="text-[#082952]">Arts & Humanities</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">English</Badge>
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">History</Badge>
                  <Badge variant="secondary" className="bg-[#8ecae6]/20 text-[#082952]">Social Studies</Badge>
                </div>
                <p className="text-sm text-[#082952] mt-3">
