        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <MessageSquare className="h-6 w-6 text-[#219ebc] mr-2" />
                  <CardTitle className="text-[#082952]">Undergraduate Requirements</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">IELTS Academic</span>
                    <Badge className="bg-[#219ebc] text-white">6.0 overall</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">TOEFL iBT</span>
                    <Badge className="bg-[#219ebc] text-white">79 overall</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">PTE Academic</span>
                    <Badge className="bg-[#219ebc] text-white">58 overall</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">Cambridge English</span>
                    <Badge className="bg-[#219ebc] text-white">169 overall</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <Globe className="h-6 w-6 text-[#219ebc] mr-2" />
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">IELTS Academic</span>
                    <Badge className="bg-[#219ebc] text-white">6.5 overall</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">TOEFL iBT</span>
                    <Badge className="bg-[#219ebc] text-white">90 overall</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">PTE Academic</span>
                    <Badge className="bg-[#219ebc] text-white">65 overall</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-[#8ecae6]">
                    <span className="font-medium text-[#082952]">Cambridge English</span>
                    <Badge className="bg-[#219ebc] text-white">176 overall</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <BookOpen className="h-6 w-6 text-[#219ebc] mr-2" />
              ...
              <CardContent>
                <ul className="space-y-3 text-[#082952]">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-[#219ebc] rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <Award className="h-6 w-6 text-[#219ebc] mr-2" />
          ...
          <div className="bg-[#ffb703]/10 rounded-lg p-6 border border-[#ffb703]/30">
            <h3 className="text-xl font-bold text-[#082952] mb-4 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg border border-[#8ecae6]">
