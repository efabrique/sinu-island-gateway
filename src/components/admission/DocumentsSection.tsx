        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <FileText className="h-6 w-6 text-[#219ebc] mr-2" />
                  <CardTitle className="text-[#082952]">Academic Documents</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center justify-between p-3 bg-[#8ecae6]/10 rounded-lg">
            ...
            <Card className="border-[#219ebc] hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center mb-2">
                  <Upload className="h-6 w-6 text-[#219ebc] mr-2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                <FileText className="h-12 w-12 text-[#219ebc] mx-auto mb-2" />
            ...
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                <CheckCircle className="h-12 w-12 text-[#219ebc] mx-auto mb-2" />
            ...
            <Card className="border-[#8ecae6] hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                <AlertCircle className="h-12 w-12 text-[#219ebc] mx-auto mb-2" />
          ...
          <div className="bg-[#ffb703]/10 rounded-lg p-6 border border-[#ffb703]/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-[#082952] mb-3">Submission Requirements</h4>
                <ul className="space-y-2 text-[#082952] text-sm">
              ...
              <div>
                <h4 className="font-semibold text-[#082952] mb-3">Additional Information</h4>
                <ul className="space-y-2 text-[#082952] text-sm">
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 text-[#219ebc] mr-2 mt-0.5 flex-shrink-0" />
