...
const InternationalStudyOptions: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-6 py-10">
          ...
          <p className="text-lg text-[#082952] max-w-3xl mx-auto">
            Choose from our range of undergraduate & postgraduate programs designed to prepare you for success 
...
export default InternationalStudyOptions;
