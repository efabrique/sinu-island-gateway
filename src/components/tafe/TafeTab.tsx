...
const tabs = [
  { label : 'Why Enrol', path: '/tafe-enroll'},
  { label: 'Admission & Entry', sectionId: 'tafe-admission' },
  { label: 'Courses', sectionId: 'tafe-courses' },
...
const TafeTab: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6">
      {/* Tabs */}
      <div className="flex flex-wrap gap-9 border-b border-gray-300 pb-2">
        {tabs.map((tab) => (
          <button
            key={tab.label}
