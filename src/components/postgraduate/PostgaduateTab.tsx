      ...
      <div className="flex flex-wrap gap-10 border-b border-gray-300 pb-2">
        {tabs.map((tab) => (
          <button
            ...
            className=" px-4 py-2 text-sm md:text-base text-gray-700 hover:text-blue-600 border-b-2 border-transparent hover:border-blue-500 transition bg-transparent font-bold"
          >
            {tab.label}
          </button>
        ))}
