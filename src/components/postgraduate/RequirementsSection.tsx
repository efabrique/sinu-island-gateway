      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-semibold text-[#082952] mb-6">
              ...
              <div className="mt-8 p-4 bg-[#8ecae6] rounded-lg">
                <h4 className="font-semibold text-[#082952] mb-2">Additional Requirements</h4>
              ...
              <div className="space-y-6">
                {applicationSteps.map((step, index) => (
                  <div key={index} className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#082952] mb-1">{step.title}</h4>
