...
const tabs = [
  {label: 'Overview', sectionId: '/programme-overview'},
  { label: 'Careers', path: '/programme-careers' },
  { label: 'Study Content', sectionId: 'programme-description' },
  { label: 'How to apply', path: '/programme-apply' },
];

const ProgrammeTab: React.FC = () => {
