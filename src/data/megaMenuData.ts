    ...
    columns: [
      {
        ...
        links: [
          { title: "Admission Requirements", url: "#" },
      ...
      },
      {
        ...
        links: [
          { title: "Exchange Programs", url: "#" },
          { title: "Partner Universities", url: "#" },
    ...
    columns: [
      {
        ...
        links: [
          { title: "Marine Science & Conservation", url: "#" },
          { title: "Climate Change Adaptation", url: "#" },
    ...
    columns: [
      {
        ...
        links: [
          { title: "Student Clubs & Organizations", url: "#" },
